...
<head>
	...
	<title>CMDB DASHBOARD - REBOOT</title>
    ...
    <script src="assets/js/load_reboot_charts.js"></script>
    ...
    <div class="main-panel">
            <div class="row basic-info-bar">
                    ...
                    <div class="col-md-12 basic-info">
                       <h3 class="text-center page-title">Reboot Info</h3>
                    </div>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card height-4" id="container_reboot_enabled"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="card height-4" id="container_reboot_schedule"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card height-4" id="container_reboot_weeks"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card height-4" id="container_reboot_time"></div>
                    </div>     
                </div>
