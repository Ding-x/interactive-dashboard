...
<div class="wrapper">
    ...
    <div class="main-panel">
        <div class="row basic-info-bar">
            <div class="col-md-3 basic-info">
                <div class="row basic-info-box">
                    <div class="col-md-4 box-icon">
                        <i class="fa fa-desktop animated rollIn" style="font-size:350%;color:#BCA199"></i>
                    </div>
                    <div class="col-md-5 box-content">
                        <h5 class="animated rollIn ">Servers</h5>
                        <h4 id="server_count" class="animated rollIn"> </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 basic-info">
                <div class="row basic-info-box">
                    <div class="col-md-4 box-icon">
                        <i class="fa fa-circle-thin animated rollIn" style="font-size:350%;color:#619FA7"></i>
                    </div>
                    <div class="col-md-5 box-content">
                        <h5 class="animated rollIn ">Applications</h5>
                        <h4 id="app_count" class="animated rollIn "> </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 basic-info">
                <div class="row basic-info-box">
                    <div class="col-md-4 box-icon">
                        <i class="fa fa-link animated rollIn" style="font-size:350%;color:#C98527"></i>
                    </div>
                    <div class="col-md-5 box-content">
                        <h5 class="animated rollIn ">IPs</h5>
                        <h4 id="ip_count" class="animated rollIn "> </h4>
                    </div>        
                </div>
            </div>
            ...
            <div class="col-md-3 basic-info">
                <div class="row basic-info-box">
                    <div class="col-md-4 box-icon">
                        <i class="fa fa-user-o animated rollIn" style="font-size:350%;color:#3c5c74"></i>
                    </div>
                    <div class="col-md-5 box-content">
                        <h5 class="animated rollIn ">Owners</h5>
                        <h4 id="team_count" class="animated rollIn "> </h4>
                    </div>      
                </div>
            </div>
        </div>             
        ...
        <div class="content">
            <div class="container-fluid dashbord-alert"></div>
        </div>
