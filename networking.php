...
<head>
	...
	<title>CMDB DASHBOARD - NETWORKING</title>
    ...
    <script src="assets/js/load_networking_charts.js"></script>
    ...
    <div class="main-panel">
            <div class="row basic-info-bar">
                    ...
                    <div class="col-md-12 basic-info">
                       <h3 class="text-center page-title">Networking Info</h3>
                    </div>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <div class="card height-4" id="container_networking_zone" ></div>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-6" >
                        <div class="card height-4" id="container_networking_owner" ></div>
                    </div>
                    <div class="col-md-6">
                        <div class="card height-4" id="container_networking_ip" ></div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card height-4" style="height: 550px;overflow-y:scroll;overflow-x:hidden;padding: 30px;">
                            <div class="row">
                                ...
                                <div class="col-md-6 "><p class="text-center" style="font-weight:600;font-size: 20px" id="ipTitle">IP address on a particular VLAN</p></div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        <table id="ipTable" class="table table-striped table-bordered table-hover table-condensed" ></table>
                                </div>
                            </div>
                        </div>
                    </div>
