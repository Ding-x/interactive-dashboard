...
<head>
	...
	<title>CMDB DASHBOARD - SERVER</title>
    ...
    <script src="assets/js/load_server_charts.js"></script>
    ...
    <div class="main-panel">
            <div class="row basic-info-bar">
                <div class="col-md-12 basic-info">
                    <h3 class="text-center page-title">Server Info</h3>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card height-4" id="container_server_managed"></div>
                    </div>
                    <div class="col-md-4">
                        <div class="card height-4" id="container_server_status"></div>
                    </div>
                    <div class="col-md-4">
                        <div class="card height-4" id="container_server_type"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card height-4" id="container_server_os"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="card height-4" id="container_server_datacenter"></div>
                    </div>     
                </div>

                <div class="row">
                    <div class="col-md-12">
                        <div class="card height-4" id="container_server_owner"></div>
                    </div>     
                </div>

                <div class="row">
                    <div class="col-md-12">
                        <div class="card height-4" style="padding: 10px 5%;">
                            <div class="row">
                                <div class="col-md-3 "></div>
                                <div class="col-md-6 "><p class="text-center" style="font-weight:600;font-size: 20px">Server Information</p></div>
                                <div class="col-md-3" style="float:right">
                                    <select class="selectpicker"  data-live-search="true" data-live-search-placeholder="Search here..." ></select>
                                </div>
                            </div>
                            <hr>
                            <div class="row" id="server_detail">
                            </div>
                        </div>
                    </div>
