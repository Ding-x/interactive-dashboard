...
<head>
	...
	<title>CMDB DASHBOARD - BACKUP</title>
    ...
    <script src="assets/js/load_backup_charts.js"></script>
    ...
    <div class="main-panel">
            <div class="row basic-info-bar">
                <div class="col-md-12 basic-info">
                    <h3 class="text-center page-title">Backup Info</h3>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5">
                        <div class="card height-4" id="container_backup_baremetal" style="height:450px"></div>
                    </div>
                    <div class="col-md-7">
                        <div class="card height-4" id="container_backup_frequency" style="height:450px"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                        <div class="card height-4" style="height: 450px;padding: 10px;">
                            <div class="row">
                                <div class="col-md-6 "><p class="text-center" style="font-weight:600;font-size: 20px">Backup Policy</p></div>
                                <div class="col-md-6 " style="float:right" id="backup_selector">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        <table id="backupTable" class="table table-striped table-bordered table-hover table-condensed" ></table>
                                </div>
                            </div>
                    ...
                    <div class="col-md-7">
                        <div class="card height-4" id="container_backup_retention" style="height:450px"></div>
                    </div>     
                </div>
            </div>
        </div>
