...
<head>
	...
	<title>CMDB DASHBOARD - RETIRE</title>
    ...
    <script src="assets/js/load_retire_charts.js"></script>
    ...
    <div class="main-panel">
            <div class="row basic-info-bar">
                    ...
                    <div class="col-md-12 basic-info">
                       <h3 class="text-center page-title">Retire Info</h3>
                    </div>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card height-4" id="container_retire_daily_complete"></div>
                    </div>
                    
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card height-4" id="container_retire_wmy"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="card height-4" id="container_retire_user"></div>
                    </div>
                </div>
